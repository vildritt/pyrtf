...
class TableTestCase(RTFTestCase):
    ...
    def make_tables():
        ...
        c3 = Cell('Row One, Cell Three', 
                  ' Testing mult. strings in cell')
        ...
        thin_frame = FramePropertySet(
            thin_edge,  thin_edge,  thin_edge,  thin_edge)
        thick_frame = FramePropertySet(
            thick_edge, thick_edge, thick_edge, thick_edge)
        mixed_frame = FramePropertySet(
            thin_edge,  thick_edge, thin_edge,  thick_edge)
    ...
    def make_tableHorizontalCellMerge():
        ...
        table = Table(TableTestCase.col1,
                      TableTestCase.col2, 
                      TableTestCase.col3)
    ...
    def make_tableVerticalCellMerge():
        ...
        table.AddRow(
            Cell('A-one'), Cell('A-two', start_vertical_merge=True), Cell('A-three'))
        table.AddRow(Cell('A-one'), Cell(vertical_merge=True), Cell('A-three'))
